...
- **Quality gates:** 0 em-dash, 0 broken internal links; consistency reconciled across all families (Krok 8) and two defect critique passes applied (Krok 9 + a 2026-06-29 fresh multi-agent re-critique). The re-critique audited all 99 pages across five families and found the set clean except one minor clarity fix on `event-detail-resolved.html` (live "now" odds reframed as "Trading closed / at close" on the closed market); see `wireframes/_critique.md`.
