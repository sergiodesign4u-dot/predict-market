...
| 09 | Design System | `components/patterns/` (6 files) + `ui-kit/` (49 pages of a planned 55, rebuilt by hand 2026-08-08: a shelf per level plus one page per component, every atom, molecule and organism done) | `ui-kit/overview.html` |
| 10 | Responsive | | - |
| 11 | Animation | | - |
| 12 | Handoff | | - |
