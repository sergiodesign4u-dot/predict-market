...
| [`ui-visual/`](./ui-visual/) | **UI + Visual**: color copies of the wireframes on the Signal layer - `_theme.css` (color/type only) + `event-feed.html` (reference) + 8 state pages generated by `_apply_theme.py`; the grey wireframes stay grey |
