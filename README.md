...
- **Coverage:** 119 pages, counted 2026-08-20 - every screen in the IA screen tree, each state its own
  page. Event Feed, Event Detail (**binary and multi against one-time, recurring and resolved**, inline bet panel), 4 Category
