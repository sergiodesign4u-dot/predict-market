...
**Thirteen open classes**, two of them found while fixing the others, and four struck: **31 and 32 are
now gates 33 and 34**, so they are proofs rather than a pass, and **33 and 39 are done** - both by a
person, because both are judgements no checker could reach. Seven (34, 38, 42, 43, 44, 45 and 47)
