...
**Twelve open classes**, two of them found while fixing the others, and five struck: **31 and 32 are
...
which is the one of the five that closed in both ways at once. Six (34, 38, 42, 44, 45 and 47)
still need a person; four (35, 36, 37, 46) belong to owners outside this stage, three of them already
...
widths. The count that matters is different: **26 classes are proven, 7 are measured and 12 are open** -
and of the twelve, six are the ones that actually need eyes. Two of the eighteen inherited classes
