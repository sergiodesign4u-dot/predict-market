...
**Thirteen open classes.** Two of them (31 and 32) are mechanisable now and should become gates rather
than a pass; six (33, 34, 38, 39, 42 and 43) need a person, because each is a JUDGEMENT about where a
...
still to take; and 42 and 43 are one pair - a broken instrument reporting a clean result, once in a document and once in a photograph.
...
re-run rather than a search, and 13 are open** - and of the thirteen, six are the ones that actually
need eyes.
