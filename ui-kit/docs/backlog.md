...
**Standing today: twenty two rows opened, six closed, sixteen open.** Three closed the same afternoon
...
step by hand. Of the thirteen that remain, S9, S12 and S15 are answers rather than gaps and S14 is a
carried finding, so the real count is **nine**, and they belong to stages 10 to 12 rather than to
this one.
