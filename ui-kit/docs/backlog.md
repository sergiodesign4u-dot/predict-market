...
**Standing today: twenty two rows opened, seven closed, fifteen open.** Three closed the same
...
two words. Of the fifteen that remain, S9, S12 and S15 are answers rather than gaps, so the real
count is **twelve**, and most of them belong to stages 10 to 12 rather than to this one.
