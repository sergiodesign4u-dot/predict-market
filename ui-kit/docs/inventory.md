...
| `seo-plate` | 15 | **HOLDS its own prose blocks.** 15 documents and 74 blocks, re-counted from the rendered DOM 2026-08-19; the plate itself (`.feed-seo-wrap`) is on 10, the ten feed screens, and the other five hold the blocks bare in the slot. It said 9 while the tree had one document in it |
