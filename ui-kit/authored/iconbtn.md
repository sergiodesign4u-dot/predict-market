...
- `button.kit-here.icon-btn.icon-btn-photo.sheet-close @dialog.signin-dialog` - **The face for a photograph, and it is one block for all 333 dismissals in the product.** A scrim ground at 34 per cent, the on-photo edge and the on-photo ink, and its two states deepen the scrim rather than tinting brass: a brass tint on a photograph is a colour nobody chose competing with one nobody controls. 34 at rest, 55 hovered, 72 held.
