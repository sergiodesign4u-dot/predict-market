...
window.KIT_NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Bets table',    page: 'bets-table.html',   done: true, note: '9' },
      { label: 'Chart',         page: 'chart.html',        done: true, note: '9' },
      { label: 'Card',          page: 'card.html',         done: true, note: '167' },
      { label: 'Hero',          page: 'hero.html',         done: true, note: '1' },
      { label: 'Feed',          page: 'feed.html',         done: true, note: '105' },
      { label: 'Profile',       page: 'profile.html',      done: true, note: '2' }
    ]
  },
  {
    label: 'Patterns',
