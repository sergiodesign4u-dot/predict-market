...
window.KIT_NAV = [
  ...
  {group: "Molecules", name: "loadmore", file: "loadmore.html", label: "Load more", path: "components/loadmore.css"},
  ...
  {group: "Organisms", name: "navitem", file: "navitem.html", label: "navitem", path: "components/navitem.css"},
  {group: "Organisms", name: "yesno", file: "yesno.html", label: "YES / NO buttons", path: "components/yesno.css"},
