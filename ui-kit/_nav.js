...
window.KIT_NAV = [
  ...
  {group: "Molecules", name: "notice", file: "notice.html", label: "Notices and banners"},
  ...
  {group: "Organisms", name: "outcome-dialog", file: "outcome-dialog.html", label: "Win and loss overlays"},
  {group: "Organisms", name: "betpanel", file: "betpanel.html", label: "Bet panel and dock"},
  {group: "Organisms", name: "signin", file: "signin.html", label: "Sign in dialog"},
